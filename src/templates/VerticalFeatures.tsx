...
const VerticalFeatures = () => (
  ...
  >
    <VerticalFeatureRow
      ...
      description="Dedrop uses the streamr network, which has light nodes on 6 out of the 7 continents. You can also run a light node yourself by simply going to https://streamr.network/"
